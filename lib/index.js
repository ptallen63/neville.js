...
var neville = function () {
	...
	stdin.addListener("data", function(d) {
		...
		var parser = csv.parse({delimiter: ','}, function(err, data){
		    ...
		    func.writeToOutput('cleaned.csv',cleaned);
			
			func.writeToOutput('duplicates.csv',dups);
			
			func.writeToOutput('blanks.csv',blanks);
			
			func.writeToOutput('invalid.csv',invalid);
