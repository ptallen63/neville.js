...
var neville = function () {
	...
	stdin.addListener("data", function(d) {
		...
		var parser = csv.parse({delimiter: ','}, function(err, data){
		    ...
		    func.writeToOutput('cleaned.csv',cleanedCSV);
			
			func.writeToOutput('duplicates.csv',dupsCSV);
			
			func.writeToOutput('blanks.csv',blanksCSV);
			
			func.writeToOutput('invalid.csv',invalidCSV);
